...
&\leqslant E\left[  \left\| \int_{0}^{t} \boldsymbol{b}(\boldsymbol{X}_{0}, s) \, \mathrm{d}s \right\|^{2}  \right] + E\left[  \left\| \int_{0}^{t} \boldsymbol{B}(\boldsymbol{X}_{0}, s) \, \mathrm{d}\boldsymbol{W}  \right\|^{2}  \right]
\end{align}
$$
