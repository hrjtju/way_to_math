...
> $$H_{n}(x, t) \coloneqq \frac{(-1)^{n}}{n!} \exp\left\{ \frac{x^{2}}{2t} \right\} \displaystyle \frac{ \mathrm{d}^{n} }{ \mathrm{d}x^{n} } \exp\left\{ \frac{-x^{2}}{2t} \right\}$$

> **定理 4.13 （Hermite 多项式和随机积分）**
> $$\mathrm{d} H_{n+1}(W, t) = H_{n}(W, t) \mathrm{d} W$$

**证明.**
我们知道 $\displaystyle \mathrm{d} \frac{x^{n}}{n!} = \frac{x^{n-1}}{(n-1)!} \mathrm{d}x$，它的形式和这个很像。我们也可以考虑把某个东西做类似 Taylor 展开一样的展开。在这里我们的选择是 $u= \displaystyle \exp \left\{- \frac{(x - \lambda t)^{2}}{2t}  \right\}$。
...
$$
\left. \frac{ \mathrm{d} }{ \mathrm{d}\lambda } \exp \left\{ -\frac{(x - \lambda t)^{2}}{2t}  \right\}\right|_{\lambda = 0} = \left. (x-\lambda t) \exp \left\{ -\frac{(x - \lambda t)^{2}}{2t}  \right\}\right|_{\lambda = 0} = x \exp \left\{ -\frac{x^{2}}{2t} \right\} 
$$
另一方面，我们要看看构成 Hermite 多项式的零部件
$$
\displaystyle \frac{ \mathrm{d} }{ \mathrm{d}x } \exp\left\{  -\frac{x^{2}}{2t}  \right\} = -\frac{x}{t} \exp\left\{  -\frac{x^{2}}{2t}  \right\}
$$
接下来我们猜想
$$
\left. \frac{ \mathrm{d}^{n} }{ \mathrm{d}\lambda^{n} } \exp \left\{ -\frac{(x - \lambda t)^{2}}{2t}  \right\}\right|_{\lambda = 0} = (-t)^{n} \displaystyle \frac{ \mathrm{d} }{ \mathrm{d}x } \exp\left\{  -\frac{x^{2}}{2t}  \right\}
$$
$n=0,1$ 时已经验证过（或不言自明），接下来用归纳法。假设 $n-1$ 时成立，有
$$
\begin{align}
\left. \frac{ \mathrm{d}^{n} }{ \mathrm{d}\lambda^{n} } \exp \left\{ -\frac{(x - \lambda t)^{2}}{2t}  \right\}\right|_{\lambda = 0} 
&= \displaystyle \frac{ \mathrm{d} }{ \mathrm{d}\lambda } \left. \frac{ \mathrm{d}^{n} }{ \mathrm{d}\lambda^{n} } \exp \left\{ -\frac{(x - \lambda t)^{2}}{2t}  \right\}\right|_{\lambda = 0}\\ 
&= \displaystyle \frac{ \mathrm{d} }{ \mathrm{d}\lambda } (-t)^{n} \displaystyle \frac{ \mathrm{d} }{ \mathrm{d}x } \exp\left\{  -\frac{x^{2}}{2t}  \right\}\\ 
&= \frac{ \mathrm{d} }{ \mathrm{d}x } \exp\left\{  -\frac{x^{2}}{2t}  \right\}
\end{align}
$$
