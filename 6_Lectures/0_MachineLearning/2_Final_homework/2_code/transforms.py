...
class RandomFlip:
    ...
    def __init__(self, random_state: np.random.RandomState = GLOBAL_RANDOM_STATE, axis_prob: float = 0.5, **kwargs):
...
class RandomRotate90:
    ...
    def __init__(self, random_state: np.random.RandomState = GLOBAL_RANDOM_STATE, **kwargs):
        self.random_state = random_state
...
class RandomRotate:
    ...
    def __init__(
        self,
        random_state: np.random.RandomState = GLOBAL_RANDOM_STATE,
...
class CropToFixed:
    ...
    def __init__(
        self, random_state: np.random.RandomState = GLOBAL_RANDOM_STATE, size: tuple[int, int] = (256, 256), centered: bool = False, **kwargs
    ):
        self.random_state = random_state
